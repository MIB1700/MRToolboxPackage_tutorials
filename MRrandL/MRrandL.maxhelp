...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "-1.320125 3.287125 10.39275 -2.180125 -4.03575 -3.72275 1.98725 0.854625 -1.69175 1.275375"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "-15 5 -1 3 14 -2 -15 4 -30 -12 11 -17 -10 -30 -4 14 -21 -2 4 -11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 651.0, 311.0, 149.0, 62.0 ],
					"text" : "60 30 21 15 94 54 20 18 90 25 92 52 95 91 73 53 96 50 100 62 49 12 79 44 92"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "46 76 62 74 68 51 58 66 43 52 64 46 63 46 54 76 49 45 62 66"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 247.0, 148.0, 62.0 ],
					"text" : "0.282375 8.140125 9.984375 -1.396375 1.195 -1.011875 7.394875 8.554 0.47675 8.40725"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "MRrandL.maxpat",
				"bootpath" : "~/Documents/Music/Max/MRToolboxPackage/patchers/MRrandL",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "MRtype.maxpat",
				"bootpath" : "~/Documents/Music/Max/MRToolboxPackage/patchers/MRtype",
...
, 			{
				"name" : "MRdelta.maxpat",
				"bootpath" : "~/Documents/Music/Max/MRToolboxPackage/patchers/MRdelta",
